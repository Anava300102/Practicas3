...
import { Box, Heading, Input, Stack, Divider, FormControl, Icon, Pressable, Radio, Select, CheckIcon, Center, HStack, Checkbox, Link, Button,VStack,ScrollView,Slider,TextArea,Switch,Text} from "native-base";
      ...
      <Center flex={1}>
        <Box safeArea w="90%" maxW="290" py="8">
          <VStack space={3} mt="5">
            ...
            {/* No olviden crear la constante age: const [age, setAge] = React.useState(10); */}
